<script lang="ts">
  ...
  let { label, description, icon: Icon = ImageIcon, preview, uploading, onUpload, accept = "image/png" }: {
    label: string;
    description: string;
...
<div
  ...
  class="flex items-center gap-3 p-3 rounded-xl bg-secondary/30 ring-1 ring-border/30 cursor-pointer hover:bg-secondary/50 transition-colors group"
>
